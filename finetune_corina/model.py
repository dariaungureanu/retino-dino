"""
Multi-Label DINOv2 Model for Corina (DME biomarker detection).

4 independent sigmoid outputs: DME, HF, ND, Healthy.
Uses BCEWithLogitsLoss (sigmoid applied inside loss function).
"""
...
class CorinaModel(nn.Module):
    ...
    def __init__(self, backbone, num_labels=4, freeze_backbone=True,
        ...
        # multi-label: num_labels independent sigmoid outputs

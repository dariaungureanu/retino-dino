...
class OCTDL_SSL_Dataset(Dataset):
    def __init__(self, root_dir):
        ...
        # Căutăm recursiv toate imaginile jpg/png
        ...
        # Augmentări DINOv2 (Simplificate pt 3060 Ti)
        # Global: 518px (sau 224px dacă dă Memory Error)
        self.img_size = 518

        self.global_transfo1 = transforms.Compose([
            transforms.RandomResizedCrop(self.img_size, scale=(0.4, 1.0), interpolation=3),  # 3 is BICUBIC
    ...
    def __getitem__(self, idx):
        try:
            ...
            # Generăm doar 2 vederi globale pentru a economisi memorie pe 3060 Ti
            # (Oficial se folosesc și local crops, dar consumă mult RAM)

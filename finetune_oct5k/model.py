"""
Multi-Label DINOv2 Model for OCT5k (biomarker detection).

9 independent sigmoid outputs for biomarker detection.
...
class OCT5kModel(nn.Module):
    ...
    def __init__(self, backbone, num_labels=9, freeze_backbone=True,
